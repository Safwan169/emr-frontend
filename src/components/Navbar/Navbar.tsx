...
const Navbar: FC<NavbarProps> = ({ onToggleSidebar }) => {
  ...
  return (
    <>
      <div className=" w-full  mt-0 ">
        <div className="flex justify-between items-center   shadow-sm px-4 py-4 m-2 rounded-lg bg-white">
          ...
          <div className="flex  items-center gap-4">
            ...
            <h2 className="text-xl hidden lg:block font-semibold">{title?.title || "EMR Dashboard"}</h2>
          </div>
          ...
          <div className="flex items-center gap-4">
            ...
            <button
              ...
              className="md:hidden bg-gray-100 rounded-full p-2 hover:bg-gray-200"
            >
            ...
            >
              ...
              {/* Dropdown Menu */}
              <div
                className={`absolute right-0 mt-2 w-44 bg-white border border-gray-200 rounded-md shadow-lg z-50 transform transition-all duration-300 ease-in-out ${isDropdownOpen ? "opacity-100 scale-100" : "opacity-0 scale-95 pointer-events-none"
                  }`}
              >
      ...
      {isMobileSearchOpen && (
        <div className="md:hidden bg-white mx-2 px-6 py-3 shadow-sm rounded-lg mt-2">
          <div className="relative">
            <Search className="absolute left-3 top-2.5 text-gray-400" size={18} />
            <input
              type="text"
              placeholder="Search anything here..."
              className="bg-gray-100 rounded-lg pl-9 pr-3 py-2 text-sm w-full focus:outline-none focus:ring-2 focus:ring-blue-500"
              autoFocus
            />
          </div>
        </div>
