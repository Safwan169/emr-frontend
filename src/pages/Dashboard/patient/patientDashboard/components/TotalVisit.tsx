...
//       {/* Left Section */}
//       <div className="w-full lg:w-1/2 rounded-2xl py-5 px-5  flex flex-col justify-between">
...
//               <div
//                 key={index}
//                 className="h-[156px] flex flex-col justify-between rounded-[12px] p-6 bg-white  w-full"
//               >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 w-full">
          {cardData.map((card, index) => {
            ...
            return (
              <div
                key={index}
                className="h-[156px] flex flex-col justify-between rounded-[12px] p-6 bg-white w-full shadow-sm hover:shadow-md transition"
              >
                {/* Title */}
